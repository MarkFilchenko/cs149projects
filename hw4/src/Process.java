...
/**
 * Process with pages of memory which randomly selects the next page
 * to reference. Probability of next page being within one delta is
 * random.
 */
public class Process 
{
    ...
    /** 
       * Create pages for this process from 0 through PROCESS_PAGES. Put
